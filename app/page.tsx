...
const resultsData = [
  ...
  { rank: 14, teamName: "VEGAVERSE_RGUKTN", leader: "SUDHARSHAN PAUL GANTA", psId: "SIH25073" },
  { rank: 15, teamName: "DRISTI_RGUKTN", leader: "K THARUN", psId: "SIH25047" },
  { rank: 16, teamName: "TEAM TECHTITANS", leader: "RAYI MOHAN VINAY RAJ", psId: "SIH25104" },
  ...
  { rank: 49, teamName: "AGRO_RGUKTN", leader: "NAVATEJ POLAVARAM", psId: "SIH25062" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 text-center mt-12">
        <div className="flex flex-col items-center justify-center mb-6">
          <Image src="/hackhub_white.jpg" alt="Hackhub Club Logo" width={260} height={260} className="rounded-lg mb-2" />
